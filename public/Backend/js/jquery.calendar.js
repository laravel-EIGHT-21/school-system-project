	...
	({
		...
		{	
            ...
            var defaults = 
			{
				...
				ajaxJsonFetch: 'includes2/cal_events.php',
				ajaxUiUpdate: 'includes2/cal_update.php',
				ajaxEventSave: 'includes2/cal_save.php',
				ajaxEventQuickSave: 'includes2/cal_quicksave.php',
				ajaxEventDelete: 'includes2/cal_delete.php',
				ajaxEventEdit: 'includes2/cal_edit_update.php',
				ajaxEventExport: 'includes2/cal_export.php',
				ajaxRepeatCheck: 'includes2/cal_check_rep_events.php',
				ajaxRetrieveDescription: 'includes2/cal_description.php',
				...
				savedRedirect: 'calendar2.php',
				removedRedirect: 'calendar2.php',
				updatedRedirect: 'calendar2.php',
			...
			({
				...
				{ 
					...
					$.post(opt.ajaxEventExport, construct, function(response) 
					{
						...
						$(opt.modalViewSelector).modal('hide');
						window.location = 'includes2/Event-'+expID+'.ics';
			...
			if(opt.filter == true)
			{
				$(opt.formFilterSelector).on('change', function(e) 
				{
					 ...
					 $.post('includes2/loader.php', construct, function(response) 
					{
						$(opt.calendarSelector).fullCalendar('refetchEvents');
					});	
