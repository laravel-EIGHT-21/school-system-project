...
<section class="content-header">
  ...
  <div class="row mb-2">
  <div class="col-sm-8">
  <h1>Financial Year Data Charts</h1>
  </div>
  <div class="col-sm-4">
  ...
  <div class="card no-print">
      ...
      <h3 class="card-title"><b>Enter Financial Year</b></h3>
      ...
      <div class="row">
          ...
          <div class="card-body">
           <form method="post" action="{{ route('financial-year') }}">
               @csrf
  ...
  <div class="card">
      ...
      <div class="card-header border-transparent">
      <h3 class="card-title"><b>Annual Monthly Fees Collections & Expenses</b>
...
<canvas id="purchaselinechart" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%;"></canvas>
  ...
  var ctx4 = document.getElementById("exlinechart").getContext('2d');
 ...
 var ctx5 = document.getElementById("purchase_chart").getContext('2d');
      ...
      var ctx1 = document.getElementById("purchaselinechart").getContext('2d');
