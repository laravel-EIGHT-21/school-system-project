...
<div class="row mb-2">
<div class="col-sm-6">
<h1>Update Student`s Attendance (S3 & S4) Info</h1>
</div>
...
<div class="col-12 ">
    ...
    <div class="card card-default">
        <div class="card-header">
          <h3 class="card-title"><b> Update Student`s Attendance (S3 & S4)</b></h3>
...
<form method="post" action="{{ route('update.olevel.student.attendance',$editData->id) }}" enctype="multipart/form-data">
	 	@csrf
