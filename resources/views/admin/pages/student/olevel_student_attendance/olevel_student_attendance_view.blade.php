...
<div class="row mb-2">
<div class="col-sm-12">
<h1>O-Level Students Attendance Details  </h1>
</div>
...
<div class="col-12 ">
        ...
        <div class="card card-default">
          ...
          <a href="{{ route('olevel.student.attendance.add') }}" style="float: right;" class="btn btn-rounded btn-success "> Add Students Attendance</a>			  
...
<script type="text/javascript">
  $(document).on('click','#search',function(){
    ...
    var date= $('#date').val(); 
     $.ajax({
      url: "{{ route('olevel.students.attendance.get')}}",
      type: "get",
