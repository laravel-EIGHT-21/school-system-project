...
<div class="row mb-2">
<div class="col-sm-8">
<h1>A-Level Students Attendance Information</h1>
</div>
<div class="col-sm-4">
...
<form method="GET" action="{{ route('alevel.students.general.attendance.info') }}">
...
<div class="card">
<div class="card-header">
<h3 class="card-title">A-Level Students Attendance  Information</h3>
