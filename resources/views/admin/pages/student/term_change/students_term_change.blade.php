...
<div class="row mb-2">
<div class="col-sm-6">
<h1><b>Students Term Change </b></h1>
</div>
<div class="col-sm-6">
<ol class="breadcrumb float-sm-right"> 
<li class="breadcrumb-item"><a href="#">Home</a></li>
<li class="breadcrumb-item active"> Term Change </li>
</ol>
</div> 
</div>
</div>
...
<div class="col-12 ">
        ...
        <div class="card card-default">
          ...
          <h4 class="card-title"><b> <strong>Students` Search</strong></b></h4>
             ...
             <div class="row"> <!-- start 2nd row  -->
              ...
              <div class="col-md-6">
                ...
                <div class="col-md-4" style="padding-top: 30px;">
                  ...
                  <a href="{{ route('students.term.change') }}" class="btn btn-success" >Reset</a>
...
<div class="card">
<div class="card-header">
<h3 class="card-title">Students` Term Change</h3>
...
<div class="row"> <!-- start 2nd row  -->
    ...
    <div class="col-md-4">
    <div class="form-group">
      <label>Current School Term<span style="color:red;">*</span></label>
