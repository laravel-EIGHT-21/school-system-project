...
<a href="{{ route('student.registration.view') }}" class="btn btn-sm btn-success" style="float: right;">Back to Details</a>
...
<form method="post" action="{{ route('update.student.registration',$student->id) }}" enctype="multipart/form-data">
	 	@csrf
...
<b><hr /></b>
    ...
    <div class="col-4">
        ...
        <input type="text" name="mname" class="form-control" required=""  value="{{ $student->mname }}" > 
           ...
           <div class="col-4">
            ...
            <input type="text" name="mobile" class="form-control" required=""  value="{{ $student->mobile }}" > 
                 </div>
               </div>
  ...
  <div class="row">
    ...
    <div class="col-4">
        ...
        <input type="text" name="mobile2" class="form-control" required=""  value="{{ $student->mobile2 }}" > 
             </div>
           </div>
...
<button type="submit" class="btn btn-rounded btn-primary mb-5">Update Student Details </button>
