...
<title>{{ $details['product']['name'] }} Purchase  - Invoice</title>
...
<div class="row mb-2">
<div class="col-sm-6">
<h1>PURCHASE ITEM : {{ $details['product']['name'] }}</h1>
</div>
<div class="col-sm-6">
...
<div class="col-sm-4 invoice-col">
<address>
<strong>PRODUCT : {{ $details['product']['name'] }}</strong><br>

<b>PURCHASE DATE : </b>	{{ $details->date }}<br>
</address>
</div>
...
<tbody>
	...
	<tr>
		...
		<td>{{ $details->term }}</td>
		<td>{{ $details->total_price  }} ugx</td>
		<td>{{ $details->unit_price  }} ugx</td>
