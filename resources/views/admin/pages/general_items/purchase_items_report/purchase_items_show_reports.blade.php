...
Email: <a href="">{{ $setting->email}}</a>
        ...
        <div class="col-12">
            <div>
                <div class="p-2">
                    <h3 class="font-size-16"><strong>Annual Termly Purchased Item Report Details For - 
...
<th class="text-center"><strong>Total Px</strong></th>
...
<strong>Total Price Amount</strong></td>
