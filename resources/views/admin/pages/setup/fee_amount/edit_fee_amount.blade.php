  ...
  <div class="col-12 ">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title"><b>Edit Fee Amount Details</b></h3>
...
<option value="Senior 1" {{ $edit->class == 'Senior 1' ? 'selected' : ''  }} >Senior 1</option>
<option value="Senior 2" {{ $edit->class == 'Senior 2' ? 'selected' : ''  }}>Senior 2</option>
<option value="Senior 3" {{ $edit->class == 'Senior 3' ? 'selected' : ''  }}>Senior 3</option>
<option value="Senior 4" {{ $edit->class == 'Senior 4' ? 'selected' : ''  }}>Senior 4</option>
<option value="Senior 5" {{ $edit->class == 'Senior 5' ? 'selected' : ''  }}>Senior 5</option>
<option value="Senior 6" {{ $edit->class == 'Senior 6' ? 'selected' : ''  }}>Senior 6</option>
</select>
</div>
</div> <!-- end col md 4 -->
...
<div class="col-md-3">
	...
	<option value="Day" {{ ($edit->day_boarding == 'Day')? 'selected':'' }}>Day </option>
	<option value="Boarding" {{ ($edit->day_boarding == 'Boarding')? 'selected':'' }}>Boarding </option>
...
<button type="submit"  class="btn btn-rounded btn-primary mb-5">Update Fee Category Amount </button>
