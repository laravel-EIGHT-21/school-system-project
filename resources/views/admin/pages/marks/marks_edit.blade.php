...
<div class="row mb-2">
<div class="col-sm-6">
<h1>Update Student`s Marks Info</h1>
</div>
<div class="col-sm-6">
<ol class="breadcrumb float-sm-right">
<li class="breadcrumb-item"><a href="#">Home</a></li>
<li class="breadcrumb-item active">Student`s Marks</li>
</ol>
</div>
</div>
</div>
...
<div class="col-12 ">
    ...
    <div class="card card-default">
        <div class="card-header">
          <h3 class="card-title"><b> Update Student`s Marks</b></h3>

          @can('students-marks-details')
    <a href="{{ route('marks.entry.details') }}" class="btn btn-success" style="float: right;">View Results Details </a>
    @endcan
        </div>
        <!-- /.card-header -->
...
<form method="post" action="{{ route('marks.entry.update',$editData->id) }}" enctype="multipart/form-data">
	 	@csrf
...
<input type="text" name="marks" class="form-control" required  value="{{ $editData->marks }}" > 
	 </div>
   </div>
