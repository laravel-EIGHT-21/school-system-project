...
<div class="row mb-2">
<div class="col-sm-8">
<h1><b>Competency Results Entry </b></h1>
</div>
<div class="col-sm-4">
<ol class="breadcrumb float-sm-right"> 
<li class="breadcrumb-item"><a href="#">Home</a></li>
<li class="breadcrumb-item active"> Competency Results Entry </li>
</ol>
</div> 
</div>
</div>
...
<div class="container-fluid">
<form method="post" action="{{ route('competency.results.store') }}">
			@csrf
<div class="row">
...
<div class="col-12 ">
    ...
    <a href="{{ route('competency.results.details') }}" class="btn btn-success" style="float: right;">View Details</a>
@endcan
...
<div class="card">
<div class="card-header">
<h3 class="card-title"> Students` Competency Results Entry</h3>
</div>
     ...
     $.ajax({
      ...
      success : function (data) {
        ...
        $.each( data, function(key, v){
          ...
          '<td>'+v.name+'</td>'+
          '<td>'+v.gender+'</td>'+
          '<td><input type="text" class="form-control form-control-sm" name="score[]" required=""></td>'+
          '</tr>';
        });
