...
<div class="row mb-2">
<div class="col-sm-6">
<h1>Update O-Level Student`s Marks Info</h1>
</div>
<div class="col-sm-6">
<ol class="breadcrumb float-sm-right">
<li class="breadcrumb-item"><a href="#">Home</a></li>
<li class="breadcrumb-item active">O-level Student`s Marks</li>
</ol>
</div>
</div>
</div>
...
<div class="col-12 ">
    ...
    <div class="card card-default">
        <div class="card-header">
          <h3 class="card-title"><b> Update O-level Student`s Marks</b></h3>

          @can('olevel-marks-details')
    <a href="{{ route('marks.olevel.entry.details') }}" class="btn btn-success" style="float: right;">View Results Details </a>
    @endcan
...
<form method="post" action="{{ route('marks.olevel.entry.update',$editData->id) }}" enctype="multipart/form-data">
	 	@csrf
...
<input type="text" name="paper1_marks" class="form-control" required  value="{{ $editData->paper1_marks }}" > 
	 </div>
   </div>
...
<input type="text" name="paper2_marks" class="form-control"  value="{{ $editData->paper2_marks }}" > 
	 </div>
   </div>
    ...
    <div class="row">
        ...
        <div class="col-4"> 
            <div class="form-group">
            <label>Third Paper Marks </label>
            <input type="text" name="paper3_marks" class="form-control" value="{{ $editData->paper3_marks }}" > 
                 </div>
               </div>
...
<button type="submit" class="btn btn-rounded btn-primary mb-5">Update Student`s Marks </button>
