...
<li class="breadcrumb-item active">Students Marks Details </li>
</ol>
</div>
</div>
</div>
...
<div class="col-12 ">
        ...
        <div class="card card-default">
          ...
          <h4 class="card-title">Student`s <strong>Marks Details </strong></h4>

          @can('students-marks-details')
    <a href="{{ route('marks.entry.add') }}" class="btn btn-success" style="float: right;">Add Marks For Students </a>
    @endcan
