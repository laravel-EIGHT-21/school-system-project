...
<div class="col-12 ">
        ...
        <div class="card card-default">
          ...
          <h4 class="card-title">A-Level Student`s <strong>Points Details</strong></h4>

          @can('alevel-points-details')
        <a href="{{ route('alevel.marks.entry.add') }}" class="btn btn-success" style="float: right;">Add Students Results </a>
        @endcan
...
<div class="card">
<div class="card-header">
<h3 class="card-title"> Student`s Points Details </h3>
</div>
...
<script type="text/javascript">
  $(document).on('click','#search',function(){
    ...
    var exam_type = $('#exam_type').val(); 
     $.ajax({
      url: "{{ route('alevel.student.edit.getstudents')}}",
      type: "get",
