...
<div class="row mb-2">
<div class="col-sm-6">
<h1><b>A-Level Students Points Entry</b></h1>
</div>
<div class="col-sm-6"> 
<ol class="breadcrumb float-sm-right">
<li class="breadcrumb-item"><a href="#">Home</a></li>
<li class="breadcrumb-item active"> Points Entry</li>
</ol>
</div>
</div>
</div> 
...
<div class="container-fluid">
<form method="post" action="{{ route('alevel.marks.entry.store') }}">
			@csrf
<div class="row">
...
<div class="col-12 ">
        ...
        <div class="card card-default">
          ...
          <h4 class="card-title"><b>Student`s <strong>Points Entry</strong></b></h4>
...
<div class="card">
<div class="card-header">
<h3 class="card-title">Enter Student`s Points </h3>
</div>
     ...
     $.ajax({
      ...
      success: function (data) {
        ...
        $.each( data, function(key, v){
          ...
          '<td><input type="text" maxlenght="1" class="form-control form-control-sm" required="" name="points[]" ></td>'+
          '</tr>';
        });
