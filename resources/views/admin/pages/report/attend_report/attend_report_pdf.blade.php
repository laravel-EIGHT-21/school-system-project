...
<html>
<head>
	<title>{{ $allData['0']['user']['name'] }}`s Attendance - Report</title>
	...
	<section>
		<div class="details clearfix">
			<div class="client left">
				<p>Teacher`s Name : {{ $allData['0']['user']['name'] }} </p>
		
				<p>
				Telephone : {{ $allData['0']['user']['mobile'] }} 
				</p>

        <p>
        Title : {{ $allData['0']['user']['designation']['name'] }}
				</p>
				...
				<table>
					<tbody class="head">
						<tr>
							...
							<th class="total"><div>Dates</div></th>
							<th class="total"><div>Attendance Status</div></th>
					...
					<tbody class="body">
						<tr>
							...
							<td class="total">{{ Carbon\Carbon::parse($value->date)->format('l d F Y')}}</td>
							<td class="total"> {{ $value->attend_status }}</td>
        ...
        <div class="no-break">
				<table class="grand-total">
					<tbody>
						...
						<tr class="total">
            <td class="grand-total" colspan="3"><div><span>TOTAL PRESENT:</span>{{ $presents }}</div></td>
            <td class="grand-total" colspan="3"><div><span>TOTAL ABSENT:</span>{{ $absents }}</div></td>
            <td class="grand-total" colspan="3"><div><span>TOTAL LEAVE:</span>{{ $leaves }}</div></td>
						</tr>
					</tbody>
				</table>
			</div>
			...
			<br><br><br><br>
			<div class="no-break right"> 
				
      <figure>

<?php $details = '/upload/admin_images/'.$allData['0']['user']['profile_photo_path']; ?>

<img src="{{ public_path() . $details }}" width="65" height="75">
</figure>
