...
Email: <a href="">{{ $setting->email}}</a>
        ...
        <div class="col-12">
            <div>
                <div class="p-2">
                    <h3 class="font-size-16"><strong>Annual Medical Supply Purchase Report  For - 
...
<th class="text-center"><strong>Purchase No </strong></th>
<th class="text-center"><strong>Month </strong></th>
<th class="text-center"><strong>Purchase Date </strong></th>
<th class="text-center"><strong>Medical Supply</strong></th>
...
@php
        ...
        <tr>
           <td class="text-center">{{ $key+1 }}</td>
            ...
            <td class="text-center">{{ $item->purchase_month }}</td>
            <td class="text-center">{{ date('d-m-Y',strtotime($item->purchase_date)) }}</td>
            <td class="text-center">{{ $item['medic_supplies']['name'] }}</td>
            <td class="text-center">{{ $item->equipment_qty }} - ({{ $item['unit']['name'] }})</td>
