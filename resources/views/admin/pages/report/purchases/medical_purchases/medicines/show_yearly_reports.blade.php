...
Email: <a href="">{{ $setting->email}}</a>
        ...
        <div class="col-12">
            <div>
                <div class="p-2">
                    <h3 class="font-size-16"><strong>Annual Medicines Purchase Report  For - 
...
<th class="text-center"><strong>Medicine Name</strong></th>
...
@php
        ...
        <tr>
           <td class="text-center">{{ $key+1 }}</td>
            ...
            <td class="text-center">{{ $item['medicine']['name'] }}</td>
            <td class="text-center">{{ $item->medicine_qty }} - ({{ $item['unit']['name'] }})</td>
