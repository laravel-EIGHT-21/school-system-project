...
<html>
<head>
	<title>Monthly & Yearly Profits </title>
	...
	<section>
		<div class="details clearfix">
			...
			<div class="data right">
				<div class="title">Monthly & Yearly Profits</div>
				<div class="date">
		...
		<div class="container">
			<div class="table-wrapper">
				<table>
					<tbody class="head">
						<tr>
							<th class="total"><div>Students` Fees</div></th>
							<th class="total"><div>Employees` Salaries</div></th>
							<th class="total"><div>Other Costs</div></th>
							<th class="total"><div>Total Costs</div></th>
                            <th class="total"><div>Profits</div></th>
						</tr>
					</tbody>
					<tbody class="body">
...
$student_fee = App\Models\AccountStudentFee::whereBetween('date',[$start_date,$end_date])->sum('fee_amount');
...
@endphp 
						<tr>
							<td class="total">{{ $student_fee }}</td>
							<td class="total">{{ $emp_salary }}</td>
							<td class="total">{{ $other_cost }}</td>
...
<br><br><br><br>
	<footer>
		<div class="container">
    <div class="thanks">Print Date:	{{ date("d M Y") }}</div>
					<div class="notice">
				<div>NOTICE:</div>
