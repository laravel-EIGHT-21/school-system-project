...
<div class="row mb-2">
<div class="col-sm-12">
<h1><b>O-Level Results Marks Report Generate (S3 & S4)</b></h1>
</div>
...
<div class="col-12 ">
    ...
    <div class="card card-default">
        <div class="card-header">
          <h3 class="card-title"><b> O-Level Students Results Report Generate (S3 & S4)</b></h3>
...
<form method="GET" action="{{ route('olevel.results.details.pdf',$allData->id) }}" >
			@csrf
