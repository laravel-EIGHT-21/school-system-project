...
<div class="row mb-2">
<div class="col-sm-12"> 
<h1><b>Competency Results Report Generate (S1 & S2)</b></h1>
</div>
...
<div class="col-12 ">
    ...
    <div class="card card-default">
        <div class="card-header">
          <h3 class="card-title"><b> Competency Results Report Generate (S1 & S2)</b></h3>
...
<form method="GET" action="{{ route('competency.results.details.pdf',$allData->id) }}" >
			@csrf
