...
Email: <a href="">{{ $setting->email}}</a>
        ...
        <div class="col-12">
            <div>
                <div class="p-2">
                    <h3 class="font-size-16"><strong>Annual Termly Fees Category Report Details For - 
...
@php
	  ...
	  $terms1 = App\Models\student_fees::where('term',$item->term)->where('fee_category_id',$item->fee_category_id)->where('month',$item->month)->sum('fee_amount');
      @endphp
