...
Email: <a href="">{{ $setting->email}}</a>
        ...
        <div class="col-12">
            <div>
                <div class="p-2">
                    <h3 class="font-size-16"><strong>Annual Class Termly Fees Collection  Details For - 
...
@php
	  ...
	  $terms1 = App\Models\student_fees::where('term',$item->term)->where('class',$item->class)->where('month',$item->month)->sum('fee_amount');
      @endphp
