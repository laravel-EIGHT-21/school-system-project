...
<div class="row mb-2">
<div class="col-sm-6">
<h1>Update Employee`s Leave Info</h1>
</div>
<div class="col-sm-6">
...
<div class="col-12 ">
    ...
    <div class="card card-default">
        <div class="card-header">
          <h3 class="card-title"><b> Update Employee`s Leave Details</b></h3>
...
<button type="submit" class="btn btn-rounded btn-primary mb-5">Update Employee`s Leave Info </button>
