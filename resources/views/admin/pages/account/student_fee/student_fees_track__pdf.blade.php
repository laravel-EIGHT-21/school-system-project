...
<title>{{ $details['student']['name'] }}`s Fees - Invoice</title>
...
To
<address>
<strong>{{ $details['student']['name'] }}</strong><br>

<b>IDNo:</b> {{ $details['student']['id_no'] }}<br>
<b>Fees Category:</b> {{ $details['fee_category']['name'] }}<br>
</address>
</div>

<div class="col-sm-4 invoice-col">
<b>Invoice #{{ $details->invoice_no }}</b><br>
<br>
...
<tr>
	...
	<tr>
		...
		<td>{{ $details->totalfee_amount  }} ugx</td>
		<td>{{ $details->fee_amount  }} ugx</td>
