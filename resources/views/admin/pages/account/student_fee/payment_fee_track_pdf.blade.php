...
<title>Fees Tracking - Invoice</title>
...
To
<address>
<strong>{{ $student_fees_log['student']['name'] }}</strong><br>

<b>IDNo:</b> {{ $student_fees_log['student']['id_no'] }}<br>
<b>Fees Category:</b> {{ $student_fees_log['fees_pay']['fee_category']['name'] }}<br>
<b>Term:</b> {{ $student_fees_log['fees_pay']['term'] }}<br>
</address>
</div>

<div class="col-sm-4 invoice-col">
<b>Invoice #{{ $student_fees_log->invoice_no }}</b><br>
<br>
<b>Date of  Payment:</b> {{ $student_fees_log->effected_date }}<br>
</div>
...
<div class="row">
	...
	<tbody>
		...
		<tr>
			...
			<td>{{ $student_fees_log->previous_fees }} ugx</td>
			<td>{{ $student_fees_log->increment_fees }} ugx</td>
			<td>{{ $student_fees_log->present_fees }} ugx</td>
			<td>{{ $student_fees_log->current_balance }} ugx</td>
			<td>{{ $student_fees_log->effected_date }} </td>
			<td>{{ $student_fees_log->payment_mode }} </td>
