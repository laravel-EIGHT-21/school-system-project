...
Email: <a href="">{{ $setting->email}}</a>
        ...
        <div class="col-12">
            <div>
                <div class="p-2">
                    <h3 class="font-size-16"><strong>Employees` Monthly Salary Report  For - 
...
<thead>
<tr>
<th class="text-center"><strong>Amount Left</strong></th>
...
@php
        ...
        <tr>
            ...
            <td class="text-center">{{ ($other_costs_total2)}}</td>
            <td class="text-center">{{ ($other_costs_total) }}</td>
                        
        </tr>
        @php
        $total_sum += $other_costs_total;

        $total_sum2 += $other_costs_total2;
