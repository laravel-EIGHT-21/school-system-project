...
<title>{{ $salary_log['user']['name'] }} Monthly Salary Tracking - Invoice</title>
...
<div class="row mb-2">
<div class="col-sm-6">
<h1>SALARY DETAILS FOR : {{ $salary_log['user']['name'] }}</h1>
</div>
<div class="col-sm-6">
...
To
<address>
<strong>{{ $salary_log['user']['name'] }}</strong><br>

<b>Salary For The Month :</b> {{ $salary_log->month }}<br>
<b>Title:</b> {{ $salary_log['user']['designation']['name'] }}<br>
<b>Year:</b> {{ $salary_log->year }}<br>

<b> Date Salary Picked :</b>	{{ $salary_log->effected_date }}<br>
</address>
</div>
...
<div class="row">
	...
	<tbody>
		...
		<tr>
			...
			<td>{{ $salary_log->salary_picked }} ugx</td>
			<td>{{ $salary_log->salary_left }} ugx</td>
			<td>{{ $salary_log->effected_date }} </td>
