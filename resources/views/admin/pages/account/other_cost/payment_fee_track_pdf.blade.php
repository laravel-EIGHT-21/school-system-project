...
<title>Expense Amount Tracking - Invoice</title>
...
<div class="row mb-2">
<div class="col-sm-6">
<h1>PAYMENT DETAILS FOR : {{ $other_cost_log['expense']['category']['name'] }}</h1>
</div>
<div class="col-sm-6">
...
<address>
<strong>{{ $other_cost_log['expense']['category']['name'] }}</strong><br>

<b> Date of  Payment :</b>	{{ $other_cost_log->date }}<br>
<b>Invoice #{{ $other_cost_log->invoice_no }}</b><br>
</address>
</div>
...
<tbody>
	...
	<tr>
		...
		<td>{{ $other_cost_log->previous_amount }}</td>
		<td>{{ $other_cost_log->increment_amount }}</td>
		<td>{{ $other_cost_log->present_amount }}</td>
		<td>{{ $other_cost_log->current_balance }} </td>
		<td>{{ $other_cost_log->date }} </td>
		<td>{{ $other_cost_log->payment_mode }} </td>
