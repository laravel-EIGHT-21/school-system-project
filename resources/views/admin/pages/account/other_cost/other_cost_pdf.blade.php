...
<title>{{ $details['category']['name'] }} Payment Amount - Invoice</title>
...
<div class="row mb-2">
<div class="col-sm-6">
<h1>PAYMENT DETAILS FOR : {{ $details['category']['name'] }}</h1>
</div>
<div class="col-sm-6">
...
<div class="col-sm-4 invoice-col">
<address>
<strong>EXPENSE : {{ $details['category']['name'] }}</strong><br>

<b>PAYMENT DATE : </b>	{{ $details->date }}<br>
</address>
</div>

<div class="col-sm-4 invoice-col">
<b>Invoice_No :{{ $details->invoice_no }}</b><br>
<br>
...
<tbody>
	...
	<tr>
		...
		<td>{{ $details->month }}</td>
		<td>{{ $details->term }}</td>
		<td>{{ $details->invoice_amount  }} ugx</td>
		<td>{{ $details->amount_paid  }} ugx</td>
