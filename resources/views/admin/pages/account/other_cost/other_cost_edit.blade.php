...
<div class="col-12 ">
    ...
    <div class="card card-default">
        <div class="card-header">
          <h3 class="card-title"><b> Update Expense Details</b></h3>
...
<input type="text" name="invoice_amount" class="form-control" required="" value="{{ $editData->invoice_amount }}"> 
	 </div>
   </div>
...
<input type="text" name="amount_paid" class="form-control" required="" value="{{ $editData->amount_paid }}" > 
	 </div>
   </div>
