...
<tr>
<th style="color:red"><b>Not Returned </b></th>
@php 
...
<tr>
<th style="color:blue"><b>Recovered  </b> </th>
<th style="color:darkblue"><b> {{ $issued_book->books_recovered }} </b></th>
</tr>


<tr>
<th> Recovery Date  </th>
<th> {{ $issued_book->recovered_date }} </th>
</tr>
...
@if($issued_book->issue_status == 'Less-Books Submitted')
<p><b><span style="color:green">{{ $issued_book->less_qty }}  Books Were Returned & Submitted</span></b></p>
@endif
...
@if($issued_book->recovered_status == 1)
<tr>
<th></th>
<th> 
@if($issued_book->issue_status == 'Less-Books Submitted')
<p><b><span style="color:blue"> {{ $issued_book->books_recovered }} Book(s) Recovered & Returned</span></b></p>
@endif
