...
<select name="author_id" required="" class="form-control select2">
...
<div class="col-4">
<div class="form-group">
<img id="showImages"  style="width: 100px; width: 100px; border: 1px solid #000000;"> 
</div>
...
<button type="submit" class="btn btn-rounded btn-primary mb-5">Add New Book Details </button>
